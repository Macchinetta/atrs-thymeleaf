...
public class TicketSharedServiceImpl implements TicketSharedService {
    ...
    private void validateFlightDepartureDateForRoundTripFlight(Flight outwardFlight,
        ...
        // 復路のフライト出発時刻
        DateTime homewardDepartureDateTime =
                DateTimeUtil.toDateTime(homewardFlight.getDepartureDate(),
    ...
    public void validateDepatureDate(Date departureDate) throws BusinessException {
        ...
        Interval reservationAvailableInterval =
                new Interval(sysDateMidnight, limitDateMidnight.plusDays(1));
    ...
    public boolean isAvailableFareType(FareType fareType, Date depDate) {
        ...
        // 予約開始日付
        DateTime rsrvAvailableStartDate =
                depDateMidnight.minusDays(fareType.getRsrvAvailableStartDayNum());

        // 予約終了日付
        DateTime rsrvAvailableEndDate =
                depDateMidnight.minusDays(fareType.getRsrvAvailableEndDayNum());
