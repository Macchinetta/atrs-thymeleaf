...
(function ($) {
    ...
    tsp = ts.pager = {
        init: function (table) {
            ...
            p.totalRows = c.$tbodies
                .eq(0)
                .children("tr")
                .not(c.widgetOptions.pager_countChildRows ? "" : "." + c.cssChildRow).length;
        ...
        showAllRows: function (table, c) {
            ...
            if (p.ajax) {
                ...
                p.size = p.totalRows;
                p.totalPages = 1;
                c.$table.addClass("pagerDisabled").removeAttr("aria-describedby").find("tr.pagerSavedHeightSpacer").remove();
