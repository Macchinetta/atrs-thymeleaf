                ...
                if ($cells.length) {
                    ...
                    $.each(priority, function (i, type) {
                        $cells.filter("[" + dataAttrib + "^=" + type + "]").each(function () {
                            ...
                            arry = type === "row" ? math.getRow(table, wo, $t, dataAttrib) : type === "all" ? getAll : math.getColumn(table, wo, $t, type, dataAttrib);
                            if (eq[formula]) {
                                t = eq[formula](arry);
