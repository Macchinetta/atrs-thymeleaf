        ...
        format: function (table, c, wo) {
            ...
            c.$headers.each(function () {
                ...
                if (wo.headerTitle_useAria) {
                    ...
                    txt =
                        (wo.headerTitle_prefix || "") + // now deprecated
                        ($this.hasClass("sorter-false") ? wo.headerTitle_output_nosort : ts.isValueInArray(t.column, c.sortList) >= 0 ? wo.headerTitle_output_sorted : wo.headerTitle_output_unsorted);
