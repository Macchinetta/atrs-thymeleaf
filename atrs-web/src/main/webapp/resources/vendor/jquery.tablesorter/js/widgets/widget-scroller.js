...
(function ($) {
    ...
    ts.addWidget({
        ...
        init: function (table, thisWidget, c, wo) {
            ...
            $win.bind("resize", ts.window_resize).bind("resizeEnd", function () {
        ...
        format: function (table, c, wo) {
            ...
            if (!c.isScrolling) {
                ...
                $tbl.wrap('<div id="' + id + '" class="tablesorter-scroller" />')
                    .before($hdr)
                    .find(".tablesorter-filter-row")
                    .addClass("hideme");

                $cells = $hdr.wrap('<div class="tablesorter-scroller-header" style="width:' + $tbl.width() + ';" />').find("." + ts.css.header);
                ...
                resize = function () {
                    ...
                    $tbl.addClass("tablesorter-scroller-reset").find("thead").find(".tablesorter-header-inner").addClass("tablesorter-scroller-reset");
                    d = $tbl.parent();
        ...
        remove: function (table, c, wo) {
            ...
            $table.unwrap().find(".tablesorter-filter-row").removeClass("hideme").end().find("thead").show().css("visibility", "visible");
            c.isScrolling = false;
        },
    });
})(jQuery);
